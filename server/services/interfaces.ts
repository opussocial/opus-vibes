...
export interface ISchemaService {
  ...
  createType(data: { name: string, description: string, properties: any[], allowed_parent_types?: number[] }): Promise<number>;
  updateType(idOrSlug: string, data: { name: string, description: string, properties: any[], allowed_parent_types?: number[] }): Promise<void>;
